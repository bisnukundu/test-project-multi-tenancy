            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('admin.store') }}">
                        ...
                        <div>
                            ...
                            <x-text-input placeholder="Enter name..." id="name" class="block mt-1 w-full"
                                          type="text"
                                          name="name"
                                          :value="old('name')"
                            />
                        ...
                        <div>
                            ...
                            <x-text-input placeholder="Enter gmail..." id="email" class="block mt-1 w-full"
                                          type="text"
                                          name="email"
                                          :value="old('email')"
                            />
                ...
                <div class="p-6 text-gray-900">
                    <table class="border-collapse table-fixed w-full text-sm">
                        ...
                        <tr>
                            <td class="border-b border-slate-500  p-4 pl-8 text-black">Bisnu</td>
                            <td class="border-b border-slate-500  p-4 pl-8 text-black">bisnu@gmail.com</td>
